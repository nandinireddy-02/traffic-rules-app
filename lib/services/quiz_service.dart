  ...
  Future<void> _loadGradeAppropriateQuestions() async {
    _allQuestions = [
      ...
      Question(
        ...
        options: const ['Go fast! 🏃‍♂️', 'Stop! ✋', 'Slow down 🐌', 'Turn left ⬅️'],
      ...
      Question(
        ...
        options: const ['Stop ✋', 'Go carefully! 👀', 'Sleep 😴', 'Dance 💃'],
        correctAnswerIndex: 1,
      ...
      Question(
        ...
        options: const ['Go faster! 🏃‍♂️', 'Jump up! 🦘', 'Get ready to stop! ⚠️', 'Close your eyes 👀'],
      ...
      Question(
        ...
        options: const ['When cars are coming 🚗', 'When adults say it\'s safe ✅', 'Anytime you want 🤷‍♀️', 'When it\'s dark 🌙'],
        correctAnswerIndex: 1,
